<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RegistarProduto.aspx.cs" Inherits="FinalTeste.WebForm5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style6" style="margin-left: 280px; font-size: x-large;">
        ...
        <tr>
            ...
            <td class="auto-style1" style="padding-right: 50px; padding-top: 50px">
                <asp:TextBox ID="txtEsado" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
